...
public class SigninsApi {
  ...
  * Creates a new &#x60;Signin&#x60; from a &#x60;Registration&#x60;
   ...
   * @return SigninDetail
  */
  public SigninDetail createRegistrationSignin (String registrationId, String idempotencyKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'registrationId' is set
    if (registrationId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'registrationId' when calling createRegistrationSignin",
        new ApiException(400, "Missing the required parameter 'registrationId' when calling createRegistrationSignin"));
    }

    // create path and map variables
    String path = "/registrations/{registration_id}/signins".replaceAll("\\{" + "registration_id" + "\\}", apiInvoker.escapeString(registrationId.toString()));
  ...
  */
  public void createRegistrationSignin (String registrationId, String idempotencyKey, final Response.Listener<SigninDetail> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/registrations/{registration_id}/signins".replaceAll("\\{format\\}","json").replaceAll("\\{" + "registration_id" + "\\}", apiInvoker.escapeString(registrationId.toString()));
  ...
  * Signs out the last &#x60;Signin&#x60; on a &#x60;Registration&#x60;. Returns the &#x60;SigninDetail&#x60; that was signed out, if the sign out is successful.
   ...
   * @return SigninDetail
  */
  public SigninDetail createRegistrationSignout (String registrationId, String idempotencyKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'registrationId' is set
    if (registrationId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'registrationId' when calling createRegistrationSignout",
        new ApiException(400, "Missing the required parameter 'registrationId' when calling createRegistrationSignout"));
    }

    // create path and map variables
    String path = "/registrations/{registration_id}/signouts".replaceAll("\\{" + "registration_id" + "\\}", apiInvoker.escapeString(registrationId.toString()));
   ...
   * @param registrationId    * @param idempotencyKey An optional idempotency key to allow for repeat API requests. Any API request with this key will only be executed once, no matter how many times it&#39;s submitted. We store idempotency keys for only 24 hours. Any &#x60;Idempotency-Key&#x60; shorter than 10 characters will be ignored
  */
  public void createRegistrationSignout (String registrationId, String idempotencyKey, final Response.Listener<SigninDetail> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/registrations/{registration_id}/signouts".replaceAll("\\{format\\}","json").replaceAll("\\{" + "registration_id" + "\\}", apiInvoker.escapeString(registrationId.toString()));
