...
public class RegistrationDetail {
  ...
  public enum StatusEnum {
     not_started,  started,  completed,  rejected,  signed_in,  signed_out, 
  };
   ...
   **/
  @ApiModelProperty(value = "An enum describing the state of the `Registration` which can have one of the following: not_started, started, completed, rejected, signed_in signed_out")
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? registrationDetail.id == null : this.id.equals(registrationDetail.id)) &&
        ...
        (this.status == null ? registrationDetail.status == null : this.status.equals(registrationDetail.status));
  }
